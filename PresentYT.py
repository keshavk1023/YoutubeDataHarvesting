...
from googleapiclient.errors import HttpError  # Import HttpError class
...
def get_comment_detail(video_ids):
    ...
    for video_id in video_ids:
        ...
        except HttpError as e:  # Catch HttpError
            # For errors  - If comments are disabled for the video, continue to the next video
